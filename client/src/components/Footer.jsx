...
const Footer = () => {
  return (
    <div>
      <div class="flex justify-center items-center bg-green-800 mt-96 mb-5 rounded-lg shadow-lg shadow-blue-500/50">
        <div class="items-center w-full md:max-w-7xl ">
          <div class="flex flex-col justify-center items-center mt-3 space-y-2 md:mx-[50px] md:flex-row md:justify-between">
            <p class="text-md font-semibold text-gray-800 md:text-lg md:text-white">
              {" "}
              Join Our Newsletter{" "}
            </p>
          ...
          <div class="grid grid-cols-2 my-3 text-center md:grid-cols-4">
            <div class="flex flex-col leading-7 items-start ml-20">
              <h1 class="text-white text-lg font-semibold">Product</h1>
              <p>
                {" "}
            ...
            <div class="flex flex-col leading-7">
              <h1 class="text-white text-lg font-semibold">Company</h1>
              <p>
                {" "}
            ...
            <div class="flex flex-col my-6 leading-7 md:my-0">
              <h1 class="text-white text-lg font-semibold">Support</h1>
              <p>
                {" "}
                <a class="text-gray-500/80 hover:text-cyan-600" href="#">
                  Community
